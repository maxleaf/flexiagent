...
class FWROUTER_API:
    ...
    def __init__(self, multilink_db_file):
        ...
        self.request_executer = FwRequestExecuter(fwrouter_modules, fwrouter_translators, fwglobals.g.router_cfg, self._on_revert_failed)
    ...
    def _call_simple(self, request):
        ...
        try:
            ...
            if router_was_started or req == 'start-router':
                ...
                self.request_executer.execute(request, cmd_list, filter='must')
                executed = True
            else:
                executed = False
