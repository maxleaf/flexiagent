                ...
                for wan in wan_list:
                    ...
                    if current_time % 10 == 0:
                        ...
                        if not ok:
                            ...
                            if not connected:
                                self.log_debug("lte modem is disconnected on %s" % dev_id)
                    ...
                    if current_time % 60 == 0:
                        ...
                        if modem_addr:
                            ...
                            if iface_addr != modem_addr:
                                self.log_debug("%s: LTE IP change detected: %s -> %s" % (dev_id, iface_addr, modem_addr))
                                ...
                                self.log_debug("%s: LTE IP was changed: %s -> %s" % (dev_id, iface_addr, modem_addr))
